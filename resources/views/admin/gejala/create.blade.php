<x-layouts.admin title="Tambah Gejala">
    ...
    <div class="flex items-center gap-3 mb-8">
        ...
        <div>
            <h1 class="font-display text-2xl font-semibold t1">Tambah Gejala</h1>
            <p class="t2 mt-1 text-sm">Lengkapi data gejala baru beserta nilai CF pakar.</p>
        </div>
    </div>
    ...
    <div class="max-w-8xl rounded-2xl glass p-7">
        <form method="POST" action="{{ route('admin.gejala.store') }}">
            ...
            @include('admin.gejala._form', ['gejala' => null])
