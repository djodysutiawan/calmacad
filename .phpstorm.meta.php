...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Herd\calmacad\public\storage' => 'string',
            ...
            'services.fcm.server_key' => 'string',
            'services.fcm.sender_id' => 'NULL',
...
'filesystems.links.D:\\Herd\\calmacad\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.fcm.server_key','services.fcm.sender_id',
'services.fcm.project_id','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'signed','throttle','verified','role','guest.once',);
        registerArgumentsSet('routes', 'home','konsultasi.index','konsultasi.submit','konsultasi.hasil.guest',
'user.dashboard','user.riwayat','user.riwayat.show','user.profile.edit','user.profile.update',
'user.fcm.update','user.notif.index','admin.dashboard','admin.gejala.index','admin.gejala.create',
'admin.gejala.store','admin.gejala.show','admin.gejala.edit','admin.gejala.update','admin.gejala.destroy',
'admin.rekomendasi.index','admin.rekomendasi.create','admin.rekomendasi.store','admin.rekomendasi.show','admin.rekomendasi.edit',
'admin.rekomendasi.update','admin.rekomendasi.destroy','admin.playlist.index','admin.playlist.create','admin.playlist.store',
'admin.playlist.show','admin.playlist.edit','admin.playlist.update','admin.playlist.destroy','admin.users.index',
'admin.users.create','admin.users.store','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.notif.index','admin.notif.broadcast','profile.edit','profile.update',
...
'auth.reset-password','auth.verify-email','components.application-logo','components.auth-session-status','components.badge-tingkat',
'components.danger-button','components.dropdown','components.dropdown-link','components.input-error','components.input-label',
'components.layouts.admin','components.layouts.app','components.layouts.user','components.modal','components.nav-link',
...
'profile.partials.update-password-form','profile.partials.update-profile-information-form','user.dashboard','user.notification.index','user.profile.edit',
'user.riwayat.index','user.riwayat.show','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.Herd.calmacad.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','FCM_SERVER_KEY','FIREBASE_PROJECT_ID',
'FIREBASE_API_KEY','FIREBASE_SENDER_ID','FIREBASE_APP_ID','FIREBASE_VAPID_KEY','VITE_FIREBASE_API_KEY',
'VITE_FIREBASE_PROJECT_ID','VITE_FIREBASE_SENDER_ID','VITE_FIREBASE_APP_ID','VITE_FIREBASE_VAPID_KEY',);
